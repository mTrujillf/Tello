...
class NatNetClient:
    ...
    def __init__( self ):
        ...
        self.server_ip_address = "192.168.1.132"

        # Change this value to the IP address of your local network interface
        #self.local_ip_address = "127.0.0.1"
        self.local_ip_address ="192.168.1.146"
        ...
        self.tello_pos_actual = None
        self.tello_rot_actual = None
    ...
    def __unpack_rigid_body( self, data, major, minor, rb_num):
        ...
        if self.rigid_body_listener is not None:
            ...
            if new_id == 2:
                self.tello_pos_actual = pos
                self.tello_rot_actual = rot
    ...
    def __unpack_marker_set_data( self, data, packet_size, major, minor):
        ...
        for i in range( 0, marker_set_count ):
            ...
            try:
                ...
                trace_mf( "Model Name      : TelloException" )
...
#            data_dict["rigid_body_data"] = rigid_body_data
    ...
    def __unpack_rigid_body_description( self, data, major, minor):
        ...
        #trace_dd("\tTypeTello         : [%3.2f, %3.2f, %3.2f]"% (type(pos[0]), type(pos[1]), type(pos[2]) ))
    ...
    def getKeyboradInput(self,datos,timeStart):
        if dt.getKey("k") :
    ...
    def tello_vuelo(self):
        ...
        contTotal = 0
        while True:
            self.getKeyboradInput(datos,timeStart)#Detecta si se apretó alguna tecla para detener.
            ...
            psiDes = math.atan(yDes/xDes) - math.pi/2
            ...
            #datos_vuelta.append(xe)
            #datos_vuelta.append(xDesdot)
            #datos_vuelta.append(x)
            #datos_vuelta.append(u)
            #datos_vuelta.append(yDes)
            #datos_vuelta.append(ye)
            #datos_vuelta.append(yDesdot)
            ...
            self.tello.send_rc_control(0, 0, 0, r)
            cont = cont + 1
    ...
    def run( self ):
        ...
        self.tello_thread = Thread( target = self.tello_vuelo, args = ())
