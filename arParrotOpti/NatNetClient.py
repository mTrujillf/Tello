...
class NatNetClient:
    ...
    def __init__( self ):
        ...
        self.contVueltasMax = 40
        self.contVueltasActual = 1
        self.contVueltasDadas = 0
        self.signo = 1
    ...
    def __unpack_rigid_body( self, data, major, minor, rb_num):
        ...
        if self.rigid_body_listener is not None:
            self.dwh = self.rigid_body_listener( new_id, pos, rot,self.frame_actual,self.dwh)
...
#Unpack Mocap Data Functions
    def __unpack_frame_prefix_data( self, data):
        ...
        self.frame_actual = frame_number
        offset += 4
    ...
    #    dt.init()
     ...
     #   cont_frame = 0
      ...
      #  frame_actual_vuelta = self.frame_actual
        ...
        while not stop():
            # Block for input
     #       metodo = self.getKeyboradInput(datos,timeStart,metodo,start_frame,cont_frame)
            try:
