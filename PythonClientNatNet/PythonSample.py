...
def receive_rigid_body_frame( new_id, position, rotation ):
    ...
    print("z tello:   " + str(z))
    #try:
    q11,q31,q21,q01 = rotation
    print("q11 tello:   " + str(q11))
    print("q21 tello:   " + str(q31))
    print("q31 tello:   " + str(q21))
    print("q01 tello:   " + str(q01))
    ...
    yaw = -yaw
    print("roll tello:   " + str(roll))
    print("pitch tello:   " + str(pitch))
    print("yaw tello:   " + str(yaw))
    #print("Cuarto dato:  " + str(a))
    #except:
